...
public class RealPickaxeEvents {
    private static final List<SoundEvent> MINING_SOUNDS = List.of(
            ModSounds.MINING_SOUND_1.get(), ModSounds.MINING_SOUND_2.get(), ModSounds.MINING_SOUND_3.get(),
            ModSounds.MINING_SOUND_4.get(), ModSounds.MINING_SOUND_5.get(), ModSounds.MINING_SOUND_6.get()
    );
