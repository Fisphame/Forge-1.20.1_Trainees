...
public class Ways {
    ...
    public static class Use{
        ...
        public static double punishmentTimeToSunlight(ItemEntity entity) {
            ...
            // 检查是否为白天
            if (  (daytime>= 0 && daytime <= 13000) || (daytime >= 23000) //是否为白天
...
//                && level.getBrightness(LightLayer.SKY, entity.blockPosition()) == 15 //天空光照等级
                    ...
                    && !level.isThundering() //是否下雷雨
            ) {
                if (daytime >= 23000) daytime -= 24000;

                double a = 8 * 10e-8, b = 6000, c = 1;
                return a * (daytime - b) * (daytime - b) + c;
            }
